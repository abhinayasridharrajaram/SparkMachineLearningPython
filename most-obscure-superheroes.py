...
names = spark.read.schema(schema).option("sep", " ").csv("file:///C:/_harekrishnaharerama/SparkCourse/Mnames.txt")

lines = spark.read.text("file:///C:/_harekrishnaharerama/SparkCourse/Mgraph.txt")
